...
4. Click **Add to favorites** at the bottom right of the criteria list.
5. In the **Add favorite** dialog, enter the name of the report in the **Please enter a name for your report** field.
...
7. Click **OK**. The report is added to the list of favorites.

> [!TIP]
> You can edit the name and description of a favorite report by double-clicking it or selecting it and clicking **Edit**. See [Edit favorite reports][3].
